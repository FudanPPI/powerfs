#!/bin/bash
# Phase 0: Synchronous commit + error rollback tests
# Validates that metadata operations are committed synchronously
...
echo ""
echo "============================================================"
echo "  Phase 0: Synchronous Commit + Error Rollback Tests"
echo "============================================================"

build_binaries "release"
start_all_services

# Test 1: mkdir synchronous creation
test_mkdir_sync() {
