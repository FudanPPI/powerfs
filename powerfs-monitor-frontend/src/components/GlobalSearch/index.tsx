...
const ALL_ENTRIES: SearchEntry[] = [
  ...
  { key: 'cluster-topology', title: '集群拓扑', path: '/cluster-topology', icon: <ClusterOutlined />, group: '基础设施', adminOnly: true },
  { key: 'capacity-planning', title: '容量规划', path: '/capacity-planning', icon: <LineChartOutlined />, group: '基础设施', adminOnly: true },
  ...
  { key: 's3', title: 'S3 管理', path: '/s3', icon: <CloudOutlined />, group: '客户端 & 性能' },
  { key: 'kv', title: 'KV 管理', path: '/kv', icon: <KeyOutlined />, group: '客户端 & 性能' },
  { key: 'fs', title: 'FS 管理', path: '/fuse', icon: <FolderOpenOutlined />, group: '客户端 & 性能', adminOnly: true },
  { key: 'benchmark', title: '性能测试', path: '/benchmark', icon: <RocketOutlined />, group: '客户端 & 性能', adminOnly: true },
  { key: 'conflicts', title: '冲突管理', path: '/conflicts', icon: <WarningOutlined />, group: '元数据', adminOnly: true },
  { key: 'filer', title: 'Filer 状态总览', path: '/filer', icon: <CloudServerOutlined />, group: '元数据', adminOnly: true },
  { key: 'shards', title: '分片管理', path: '/shards', icon: <ClusterOutlined />, group: '元数据', adminOnly: true },
  { key: 'shard-balancing', title: '分片均衡', path: '/shard-balancing', icon: <DatabaseOutlined />, group: '元数据', adminOnly: true },
